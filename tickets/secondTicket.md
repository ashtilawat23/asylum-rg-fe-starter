...
compared to the data served from the API, the test_data.json is missing properties of `totalGranted` from the topmost object and the top level object in yearResults Array
